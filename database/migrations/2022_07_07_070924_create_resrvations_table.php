...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reservations', function (Blueprint $table) {
            ...
            $table->foreign('from')->references('id')->on('stations')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('to')->references('id')->on('stations')->onUpdate('cascade')->onDelete('cascade');
            $table->timestamps();
        });
    }
